---
feature_image: /img/covers/beans.jpg
unsplash_author: Monkgogi Samson
unsplash_author_url: https://unsplash.com/@m_samson
unsplash_photo_url: https://unsplash.com/photos/bunch-of-peanut-C0ba0-z1ZoI
title: LightBlue Bean to IBM Cloud
description: Bluetooth has evolved from the pairing nightmare days of old. Custom breakouts like the Light Blue Bean let you play with all the new (and nuanced features). Let us connect one to the IBM Cloud for real-time data.
permalink: /blog/2019/01/17/light-blue-bean-to-ibm-cloud/
tags:
  - Web
  - IoT
rating: 1
